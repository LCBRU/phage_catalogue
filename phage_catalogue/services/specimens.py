...
from phage_catalogue.services.lookups import get_host, get_medium, get_phage_identifier, get_plasmid, get_project, get_resistance_marker, get_species, get_staff_member, get_storage_method, get_strain
...
def specimen_bacterium_save(bacterium, data):
    bacterium.species = get_species(data['species'])
...
def specimen_phage_save(bacterium, data):
    ...
    bacterium.host = get_host(data['host'])
    specimen_save(bacterium, data)
